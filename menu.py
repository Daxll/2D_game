...
def main_menu():
    while True:
        ...
        myfont.render_to(world, (4, 4), "Main menu" , WHITE, None, size=64)
        world.blit(backdrop, backdropbox)
        mx, my = pygame.mouse.get_pos()
        # button_1_look = Platform(500, 100 , 197, 54, 'plat1.png')
        # button_1_look.draw(world)
        button_1 = pygame.Rect(500, 100, 250, 70)
        button_2 = pygame.Rect(500, 300, 250, 70)
        ...
        if button_2.collidepoint((mx, my)):
            if click:
                options()
        pygame.draw.rect(world, (255, 0, 0), button_1)
        pygame.draw.rect(world, (255, 0, 0), button_2)
...
def options():
    ...
    while running:
        ...
        myfont.render_to(world, (20, 20), "options", WHITE, None, size=64)
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
...
screen = pygame.display.set_mode((1080, 600), 0, 32)
